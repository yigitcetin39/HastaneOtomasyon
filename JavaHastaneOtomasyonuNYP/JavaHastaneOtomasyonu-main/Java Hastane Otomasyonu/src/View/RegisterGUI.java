...
public class RegisterGUI extends JFrame {
	...
	public RegisterGUI() {
		...
		JLabel lblNewLabel_1_1 = new JLabel("T.C. Numarasi");
		...
		JButton btn_register = new JButton("Kayıt Ol");//kay�t ol butonu
		...
		JButton btn_backto = new JButton("Geri Dön");//ana ekrana d�nmek i�in olu�turulan buton
