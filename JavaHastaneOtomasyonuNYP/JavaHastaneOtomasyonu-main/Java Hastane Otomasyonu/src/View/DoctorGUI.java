...
public class DoctorGUI extends JFrame {
	...
	public DoctorGUI(Doctor doctor) throws SQLException {
		...
		for (int i = 0; i < doctor.getWhourList(doctor.getId()).size(); i++) { //eklenen randevular�n s�raland��� k�s�m
		...
		JLabel lblNewLabel = new JLabel("Hos geldiniz Sayın," + doctor.getName());
		...
		select_time.setModel(
				new DefaultComboBoxModel(new String[] { "09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", //combo box yap�s�nda s�ralanmas� i�in girilen saatler
						"12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00" }));
		select_time.setBounds(120, 11, 61, 22);
		w_whour.add(select_time);

		JButton btn_addWhour = new JButton("Randevu Ekle"); //se�ilen bilgilerin veritaban�na eklendi�i k�s�m
		...
		JButton btn_delWhour = new JButton("Randevu Sil"); //veritaban�na eklenen randevunun silinmesi i�in olu�turdu�umuz buton
	...
	public void updateWhourModel(Doctor doctor) throws SQLException { // randevular�n g�ncel bir �ekilde listelenmesi i�in olu�turdu�umuz metot
