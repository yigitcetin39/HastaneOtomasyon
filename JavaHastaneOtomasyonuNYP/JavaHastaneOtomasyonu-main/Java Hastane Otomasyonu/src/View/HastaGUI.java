...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		doctorModel = new DefaultTableModel(); //doktorlar hastalar i�in listeleniyor
		...
		whourModel = new DefaultTableModel(); //uygun saatler hastalar i�in listeleniyor
		...
		appointModel = new DefaultTableModel(); //hastalar�n ald��� randevular listeleniyor
		...
		JLabel lblNewLabel = new JLabel("Hos geldiniz Sayın "+ hasta.getName());
		...
		for (int i = 0; i< clinic.getList().size(); i++) { //polikliniklerin hastalar i�in s�raland��� k�s�m
		...
		JButton btn_selDoctor = new JButton("Se\u00E7"); //se�ilen doktorun randevu zamanlar�n� hastalar�n g�rebildi�i k�s�m
		...
		JButton btn_addAppoint = new JButton("Randevul Al"); //se�ilen doktor ve randevu zaman�n�n veritaban�na eklenmesi i�in ilgili buton
	...
	public void updateWhourModel(int doctor_id) throws SQLException {//hastalar i�in tekrardan uygun saatleri listelenen k�s�m
		DefaultTableModel clearModel = (DefaultTableModel) table_whour.getModel();
		clearModel.setRowCount(0);
	...
	public void updateAppointModel(int hasta_id) throws SQLException { //hastalar i�in g�ncellenmi� bir bi�imde randevular�n listelenmesi
