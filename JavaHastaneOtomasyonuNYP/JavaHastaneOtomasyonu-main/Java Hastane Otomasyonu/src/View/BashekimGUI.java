...
public class BashekimGUI extends JFrame {
	...
	public BashekimGUI(Bashekim bashekim) throws SQLException {
		...
		try {
			for (int i = 0; i < bashekim.getDoctorList().size(); i++) { //model paketinde bulunan bashekim s�n�f�ndaki doktor listeleme metodu �a�r�l�yor.
		...
		btn_delDoctor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (fld_doctorID.getText().length() == 0) {
					Helper.showMsg("Lütfen gecerli bir doktor se�iniz !");
				} else {
		...
		table_doctor = new JTable(doctorModel); //haz�rlanan verilerin table'a eklenmesi
		...
		table_doctor.getModel().addTableModelListener(new TableModelListener() {
			...
			@Override
			public void tableChanged(TableModelEvent e) { //ba�hekimin ekran�nda listelenen doktorlar�n bilgilerinin de�i�tirilebildi�i k�s�m
		...
		updateMenu.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) { //s�ralanan kliniklere g�ncelleme i�lemlerini yapabildi�imiz k�s�m
		...
		deleteMenu.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) { //se�ilen klini�in silme i�leminin yap�ld��� k�s�m
				if (Helper.confirm("sure")) {
				int selID = Integer.parseInt(table_clinic.getValueAt(table_clinic.getSelectedRow(),0).toString());
				try {
		...
		table_clinic.addMouseListener(new MouseAdapter() {
			@Override 
			public void mousePressed(MouseEvent e) {//t�klanan klini�in se�ildi�i k�s�m
		...
		JButton btn_workerSelect = new JButton("Se\u00E7"); //se�ilen klinikte randevusu bulunan doktorlar� listeledi�imiz k�s�m
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(selRow >0) {
					...
					table_worker.setModel(workerModel);	
						...
						Helper.showMsg("Lütfen bir poliklinik se�iniz !");
					}
		...
		JButton btn_addWorker = new JButton("Ekle"); //se�ilen klini�e se�ilen doktorun eklendi�i k�s�m
	...
	public void updateDoctorModel() throws SQLException { // doktorlar i�in i�lem bittikten sonra g�ncel bir �ekilde s�ralanmas� i�in olu�turdu�umuz metot
	...
	public void updateClinicModel() throws SQLException { // klinikler i�in i�lem bittikten sonra g�ncel bir �ekilde s�ralanmas� i�in olu�turdu�umuz metot
